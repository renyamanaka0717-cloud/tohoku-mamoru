          ...
          <div key={`cap-${g.startTime}`} className="absolute z-10 pointer-events-none"
            ...
            <div className="relative" style={{width:'56px',height:'128px'}}>
              ...
              {(()=>{const Ic1=getTaskIcon(g.tasks[0]?.icon||defaultIconKey(g.tasks[0]?.name||''));return(
                <div className="absolute z-10" style={{top:0,left:0,width:'56px',height:'76px',borderRadius:'28px',background:g.tasks[0]?.color||'#D9A3B2',display:'flex',alignItems:'center',justifyContent:'center',boxShadow:'0 0 0 3px white'}}>
